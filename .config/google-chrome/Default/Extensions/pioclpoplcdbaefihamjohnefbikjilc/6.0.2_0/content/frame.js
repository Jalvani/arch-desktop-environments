...
(function(){
  ...
  function getFrames() {
    return document.querySelectorAll("iframe:not(#evernoteAuthTools):not(#evernoteFilingTools):not(#evernoteGlobalTools):not(#evernoteUserTools):not(#evernoteShareTools):not(#evernoteEmailSharing):not(#evernoteOptionsPage)");
  }
