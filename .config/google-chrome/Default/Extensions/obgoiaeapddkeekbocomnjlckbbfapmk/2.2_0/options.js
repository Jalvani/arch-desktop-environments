...
document.addEventListener('DOMContentLoaded', read, false);


jQuery( document ).ready(function( $ ) {
    document.getElementById('similarpordacts').checked=(localStorage.getItem('ads_status') == 'enabled')?true:false;
    document.getElementById('similarpordacts').onclick = function() {
        localStorage.setItem('ads_status', document.getElementById('similarpordacts').checked ? "enabled" : "disabled");
    }
});
