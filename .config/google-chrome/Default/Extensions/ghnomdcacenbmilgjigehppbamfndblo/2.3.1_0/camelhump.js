...
var camelHump = function(url) {
  ...
  this.extractAmazonAsin = function(str) {
    regexs = new Array(/ASIN\.1=([A-Z0-9]{10,13})(\/|$|\?|\%|\ )?/i,      /ASIN=([A-Z0-9]{10,13})(\/|$|\?|\%|\ )?/i,      /dp\/([A-Z0-9]{10,13})(\/|$|\?|\%|\ )?/i,      /dp\/product\-description\/([A-Z0-9]{10,13})(\/|$|\?|\%|\ )?/i,      /product\/([A-Z0-9]{10,13})(\/|$|\?|\%|\ )?/i,      /offer\-listing\/([A-Z0-9]{10,13})(\/|$|\?|\%|\ )?/i, /product\-reviews\/([A-Z0-9]{10,13})(\/|$|\?|\%|\ )?/i );
  ...
  this.isWishlist = function() {
    if (this.isAmazon() && this.content_url.match(/\/registry\/wishlist[\/?]/)) {
      return true;
    }
    return false;
  },
...
// do a try catch and ignore so page will work in feed.html as well as in main.js on firefox
try {
