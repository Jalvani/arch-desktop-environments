...
//$(document).ready(function(e) {
    ...
    var notifiedUserOfUpdate = false;
...
//            console.log(response.confirmation);
    ...
    function runBootStrapGrowl(purpose, content){
        if((purpose == "notifyUserOfUpdate") && (!notifiedUserOfUpdate)){
            $.bootstrapGrowl(content, { 
                //DEFAULT BOOTSTRAP GROWL VALS
/*
...
*/
    ...
    function initializeApp(userStatus, currentLocation, optionalFunctionOrigin) {   
        ...
        if(currentLocation == "Facebook"){
            composeParent = $(document).find("ul#pageNav");
        ...
        if(smsButtonContainerLoaded){
            insertMightyButton (userStatus, currentLocation, composeParent);
        }    
    ...
    function insertMightyButton (userStatus, currentLocation, composeParent) {
        ...
        if (userStatus == "userLoggedIn") {
            if(currentLocation == "Facebook"){
                ...
                var mightyJewelHTML = '<li class="navItem notifNegativeBase mightyJewel mightyClearfix"><div class="flyoutMenu openToggler" id="navAccount"><a class="jewelButton"><img id="composeLogo" height="22px" width="22px" src="' + fbNavBarLogo + '" alt="MightyText Logo"/></a></div></li>';
                
                //clear any existing buttons
                $(".mightyJewel").remove();
                
                $(mightyJewelHTML).appendTo(composeParent).each(function(){
                    console.log("successfully prepended mightyJewel");
                                
                    setupFBJewelClickHandler(this);
    
                    setupSettings(currentLocation);
                    setupFacebookModal();
...
//                updateBatteryStatusDisplay(20, '<div id="chargingIcon"><img src="' + chargingImgURL + '"/></div>', null, null, "insert dummy stat");
            ...
            if(currentLocation == "Gmail"){
                ...
                //html for signbackin link
                var signBackInHTML = '<li class="settingsLink fb" id="signInTrigger">Sign In</li>';
                //remove compose button
                $("div#fbCompose").remove();
                //disable signout link in the dropdown.
                $("li#signOutTrigger").addClass("disabled");
...
//        checkIfUserHasRunThroughTour();
    ...
    function checkIfGmailNotifContainerExists(){
        ...
        if (hangoutsEnabledCheck.length > 0){
            ...
            if(currentHost.indexOf("mail.google") > -1){
    ...
    function setupFacebookModal(){
        ...
        var fbComposeButtonHTML = '<div id="fbCompose" class="fbComposeButton composeButton"><img height="32px" width="32px" alt="fbCompose" src="' + composeImgURL + '"/></div>';
        
        //append fbcomposebutton
        $(fbComposeButtonHTML).prependTo("div#jewelContainer").each(function(){
            console.log("successfully appended composeButton");
        });
                
    };
    
    function setupFBJewelClickHandler(fbJewelButton){
    
        var existingFBDropdowns = $("div.uiToggle");
...
/*
           //if any of these are clicked, hide an open fbSettingsPane
           $("div#settingsPane.fb").hide();
*/
    ...
    function setComposeButtonClickHandler(currentLocation){
        $('.composeButton').on('click', function(){
            ...
            var mms_HTML = buildHTMLButtonCanvasMMS("4444444", currentLocation);

            var baseComposerHTML = '<div class="notificationWrapper" data-context="Compose New"><div class="mightyno"><div class="composeOuterContainer"><div class="composeInnerContainer mightyClearfix composeNew" data-step="3" data-intro="And here is a new message box with options to minimize the window, go to the web app, or close the box." data-position="left"><div class="composeHeader composeNew mightyClearfix"><div class="mightyLogo"><img src=' + logoImgURL + '></div><p class="title">New Text</p><div class="mightbtnholder"><div class=" mighthbtn minMighty"><img src=' + minImgURL + '></div><div class="mighthbtn openMighty"><img src=' + popImgURL + '></div><div class="mighthbtn closeCompose"><img src=' + closeImgURL + '></div></div></div><div class="composeBody composeNew mightyClearfix"><div class="sendTo mightyClearfix" class="mightyClearfix"><div class="sendContacts" class="mightyClearfix"><span>To:</span><input class="numberToSendTo" class="typeahead"></div></div><div class="responseArea"><div class="messageContainer"><div contenteditable="true" class="messageToSend" placeholder="Write a message..."></div></div><div class="mightdcfoot" data-step="4" data-intro="Attach photos with the paper clip and then send away." data-position="top"><div class="sendSMS"><button class="btn btn-info"><img src=' + sendImgURL + '></button></div><div class="sendMMS">' + mms_HTML + '</div><div class="emojiButtonHolder"><div id="newSMS_Emoji" class="emojiToggle"><img height="18" width="18" src="' + smileImgURL + '" alt="mightyEmojiSelector"/></div></div><div class="countContainer" style="float:right;"><span class="count"></span></div><div class="groupMMSContainer mightyClearfix"><div class="dropup mightyDropup mightyClearfix" data-selection="SendAsGroup"><a class="dropdownToggler" data-toggle="dropdown"><div class="groupTriggerContainer mightyClearfix"><img class="groupMMSIcon" height="24" width="24" src="' + groupMMSImgURL + '" alt="groupMMS"/><p class="dropdownTrigger mightyTrigger" href="#">Group</p><img width="6" height="3" class="groupMMSDropdownCaret" src="' + settingsArrowImgURL + '" alt="settingsCaret"/></div></a><ul class="dropdown-menu"><li><a class="dropdownOption mightyClearfix" data-selection="SendAsGroup" href="#"><img class="groupMMSIcon" height="16" width="16" src="' + groupMMSImgURL + '" alt="groupMMS"/>Group</a></li><li><a class="dropdownOption mightyClearfix" data-selection="SendIndividually" href="#"><img class="groupMMSIcon" height="16" width="16" src="' + sendIndividualImgURL + '" alt="groupMMS"/>Individual</a></li></ul></div></div></div></div></div></div></div></div></div>';
            
            if (currentLocation == "Facebook"){
                composerDestination = fbChatWindowContainer;
                
                //adding domain specific classes before the string is appended as html
                var adjustedComposerHTML = baseComposerHTML.replace("notificationWrapper", "notificationWrapper mightyFB fbNub _50-v _50mz _50m_ _5238");
                ...
                $(adjustedComposerHTML).prependTo(composerDestination).each(function() {
                    ...
                    $(this).find(".holder-mms-image-preview, .composeInnerContainer, .composeHeader, .mightyLogo, .title , .mightbtnholder, .composeBody , .sendTo, .sendContacts, .numberToSendTo, .responseArea, .messageContainer, .messageToSend, .sendSMS, .sendMMS, .emojiButtonHolder, .countContainer, .mightdcfoot").addClass("fb");
                ...
                //adding domain specific classes before the string is appended as html
                var adjustedComposerHTML = baseComposerHTML.replace("notificationWrapper", "notificationWrapper nH nn mightynH");
    ...
    function addGroupMMSFunctionality(composer){
        ...
        $(groupMMSDropdown).on("click", function(){
    ...
    function setSettingsAndSocialShareClickHandlers(currentLocation){
...
//                console.log("my link's offset is: " + compared["top"]);
    ...
    function setSrcOfMightyIframe(selectedMightyTextView){
        ...
        if (selectedMightyTextView === "media"){
            ...
            mightyIframeSrc = baseURLMightyIFrame + "#gmail_iFrame=classic";
//THE LINE BELOW WAS FOR WHEN I WAS TESTING PASSING HASH PARAMETERS THROUGH THE URL OF THE IFRAME TO COMMUNICATE BETWEEN THE TWO.
//            mightyIframeSrc = baseURLMightyIFrame + "#gmail_iFrame=classic&selected=" + JSON.stringify(gmailLeftNavSelectedStateCSS) + "&background=" + gmailInboxBackground;
    ...
    function insertBatStatBar(){
        ...
        if(googleNavBar.length < 1){//USER IS IN NEW GMAIL UI WITHOUT TOP NAV BAR
            ...
            if(batStatExistCheck.length < 1){
                $('<div id="batstatInitial" class="newbatterywrap newBatStatLocation mightyClearfix" data-step="2" data-intro="Keep an eye on your mobile battery level up here." data-position="left"></div>').appendTo(googleNavBarNew).each(function() {
                console.log("inserted batstat into new Google UI");
    ...
    function dynamicallySetHeightOfMightyFrame(){
        var targetHeight = (window.innerHeight * .76)
...
//        console.log("set the height to: " + targetHeight); 
    ...
    function setupSettings(currentLocation){
        ...
        if(currentLocation == "Gmail"){
            ...
            settingsPaneHTML = '<div id="settingsPane" class="mightyDropdown jewelFlyout fbJewelFlyout fb"><div id="mightyLogoHeader" class="mightyClearfix fb"><img src="' + logoImgURL + '" alt="mightyText Logo"/><span>FText</span></div><div id="userAccountDisplay" class="mightyClearfix fb">' + mightyTextAccount + '</div><ul class="fb"><li class="settingsLink fb" id="settingsTrigger">Settings</li><a target="_blank" href="http://help.mightytext.net/knowledgebase"><li class="settingsLink fb" id="helpTrigger">Help</li></a><a target="_blank" href="https://chrome.google.com/webstore/detail/gtext-from-mightytext-sms/iffdacemhfpnchinokehhnppllonacfj/reviews"><li class="settingsLink fb" id="cwsTrigger">Rate GText</li></a><li class="settingsLink fb" id="signOutTrigger">Sign Out</li></ul></div>';
            
            signoutConfirmationText = 'Are you sure you want to sign out of MightyText?\r\n(You will stay signed in to Facebook)';
            
            var settingsPaneDestination = $(".mightyJewel").find("#navAccount");
            ...
            //settings link clickhandler for Facebook.
            $("#settingsTrigger").on("click", function(){
                $("#optionsIframe").attr("src", optionsPageURL);
                $('#optionsModal').modal({
                    keyboard: true
                });
                //prevents the user from being able to scroll in the newsfeed when they are viewing the settings pane.
                $("body").addClass("stopFacebookScroll");            
            });
            
            $('#optionsModal').on('hidden.bs.modal', function () {
                $("body").removeClass("stopFacebookScroll");
            })
...
/*                 console.log("ayo"); */
        ...
        $("#signOutTrigger").on("click", function(){
            ...
            if (confirm(signoutConfirmationText)){
                signOutOfMightyText(currentLocation);    
            } else {
                //do nothing.
            }                
        });
    ...
    function signOutOfMightyText(currentLocation) {
...
/*                     if(currentLocation == "Gmail"){ */
                        initializeApp("signBackIn", currentLocation);
/*
                    } else if (currentLocation == "facebook"){
...
*/
        ...
        var getDataFromServer = $.ajax({
            ...
            success: function(response) {
                ...
                displayNotificationOfNewContent(numClean, num, contactName, textThreads, contentAuthor);
    ...
    function displayNotificationOfNewContent(scCleanNum, scNum, scName, userTexts, optionalContentAuthor) {
        ...
        if(createNotifsInGmail){    
            ...
            var textNotificationHTML = '<div class="notificationWrapper" data-context="Conversation"><div class="mightyno"><div class="composeOuterContainer"><div class="composeInnerContainer mightyClearfix conversation" data-number="' + scCleanNum + '"><div class="composeHeader mightyClearfix"><div class="mightyLogo"><img src=' + logoImgURL + '></div><span class="title">New MightyText</span><div class="mightbtnholder"><div class="mighthbtn minMighty"><img src=' + minImgURL + '></div><div class="mighthbtn openMighty"><img src=' + popImgURL + '></div><div class="mighthbtn closeCompose"><img src=' + closeImgURL + '></div></div></div><div id="' + scCleanNum + '_conversation"class="composeBody mightyClearfix conversation"><div class="sendTo mightyClearfix"><div class="sendContacts" class="mightyClearfix"></div><input class="numberToSendTo" class="typeahead" placeholder="New Contact"></div><div class="conversationHolder mightyClearfix" data-message-count="' + userTexts.length + '"></div><div class="responseArea"><div class="messageContainer" data-name="' + scNum + '"><div contenteditable="true" class="messageToSend" placeholder="Reply here..."></div></div><div class="mightdcfoot"><div class="sendSMS"><button class="btn btn-info"><img src=' + sendImgURL + '></button></div><div class="sendMMS">' + mms_HTML + '</div><div class="emojiButtonHolder"><div id="newSMS_Emoji" class="emojiToggle"><img height="18" width="18" src="' + smileImgURL + '" alt="mightyEmojiSelector"/></div></div><div class="countContainer" style="float:right;"><span class="count"></span></div></div></div></div></div></div></div>';
            ...
            if(currentHost.indexOf("www.facebook.com")> -1){
                ...
                var customNotifHTML = textNotificationHTML.replace("notificationWrapper", "notificationWrapper mightyFB fbNub _50-v _50mz _50m_ _5238");
                ...
                $(customNotifHTML).prependTo(textNotificationDestination).each(function() {
                    ...
                    $(this).find(".holder-mms-image-preview, .composeInnerContainer, .composeHeader, .mightyLogo, .title , .mightbtnholder, .composeBody , .sendTo, .sendContacts, .numberToSendTo, .conversationHolder, .messageContainer, .messageToSend, .sendSMS, .sendMMS, .emojiButtonHolder, .countContainer, .mightdcfoot").addClass("fb");
                ...
                var customNotifHTML = textNotificationHTML.replace("notificationWrapper", "notificationWrapper nH nn mightynH");
...
*/
            ...
            var htmlForMMS = '<div class="textWrapper ' + incoming_outgoing_class_string + '" id="message-id-' + uniqueTextID + '"><div class="textInnerWrapper mightyClearfix"><span class="textContent">' + textMessage + '</span></div><div id="mms-scale-down"><a id="fancyimagepopup" href="' + mms_blob_url + '" data-blobkey="' + this.mms_object_key + '"> <img class="mmsImage" src="' + mms_blob_url + '" alt="Photo in process"></a></div><div class="itemActions"><a id="forwardMessage" data-message-id="' + uniqueTextID + '" data-message-type="' + this.type + '"><img class="forwardMessage messageAction forwardMessageIcon" src="' + forwardImgURL + '"></a><a id="starMessage" data-message-id="' + uniqueTextID + '" class="unstarred"><img class="unstarredicon" src="' + unstarredImgURL + '"></a><a id="deleteMessage" data-message-id="' + uniqueTextID + '" data-message-type="' + this.type + '" data-clean-num="' + cleanNum + '"><img class="deleteOneMessage deleteOneMessageIcon" src="' + deleteImgURL + '"></a><span class="textTimeStamp">' + momentDate + '</span></div></div>';
            
            if ((this.type == 10) || (this.type == 20)) {
                $(htmlForSMS).prependTo(textHistory).each(function() {
            ...
            } else if ((this.type == 11) || (this.type == 21)) {
                if (this.mms_object_key) {
                    $(htmlForMMS).prependTo(textHistory).each(function() {
                        addItemActionsEventHandlers(this, currentTextNotif, false);
                        if(statusRoute === 2){
                            var sentMessageStatusParent = $(this).find("div.textInnerWrapper");
                            $('<div class="sentMessageStatus"><img id="sentConfirmation" src="' + clockImgURL + '"/></div>').prependTo(sentMessageStatusParent).each(function(){
                    ...
                    processIncomingPhotoTaken(this, currentTextNotif);
                }
        }
            
            if((this.type == 20) || (this.type == 21)){//CHECKING IF IT IS A GROUP MESSAGE
                if (this.inbox_outbox == 60){//CHECKING IF IT IS AN INCOMING MESSAGE                    
                    cleanContentAuthorAndThenCompareToMyContacts(this.content_author, this.id);
                }                
            }
...
//        console.log('displaying notif on Gmail from: ' + displayName);
    ...
    function cleanContentAuthorAndThenCompareToMyContacts(contentAuthorFullNum, msgID){
        ...
        chrome.runtime.sendMessage({
            ...
            console.log(response.confirmation);
            var contentAuthorFullContact = response.confirmation;
            ...
            var groupMessageIncomingContactHTMLStr = ' - <span class="contentAuthor">' + contactNameToBeDisplayed + '</span>'            
    ...
    function sanitizeTextResponse(element, removeBRTagsOptional){
		...
		/*
//CRV this is where we stopped for the night.  Essentially, we are trying to keep the white space character from ever being part of the string. 
		var firstSanitized = $(responseAreaClone).html().replace('&nbsp;', ' '); 
		var sanitizedText = firstSanitized;
		if(numberOfEmojis > 0)
			{//CRV if there are any emojis in the message body, the ENTIRE msg body will be url encoded so we must replace the + sign with it's url encoded value
				if(sanitizedText.search('http') < 0) //CRV if there are links, encoding '+' can break the link if the + is in the link
					{
						//alert('replacing + characters');
						sanitizedText = sanitizedText.replace('+', '%2B');
					}
			}
*/
		...
		if(numberOfEmojis > 0)
			...
			sanitizedText = replacePlusCharactersWithSpacesUnlessLinkENCODE(sanitizedText);
				/*
if(sanitizedText.search('http') < 0) //CRV if there are links, encoding '+' can break the link if the + is in the link
					{ //CRV no link in the message body, so encode any + characters
						//alert('replacing + characters');
						sanitizedText = sanitizedText.replace('+', '%2B');
					}
				else
					{
						if(sanitizedText.search("http") > 0)
						{ //CRV we have detected a url, but that link isn't at the start of the message body.  Thus, there may be some + characters that need to be replaced BEFORE the url begins.  This case arises when a user sends a message with body "text + link + emoji"
							sanitizedText = replacePlusCharactersBeforeLinkIfNecessaryENCODE(sanitizedText);
						}
					}
*/
			}
...
/* 					console.log(gmailNotif[0]); */
					...
					if ((context == "Conversation") && (optionalGroupMMSCheck)){//WE KNOW THAT THE USER IS REPLYING TO A GROUP THREAD CONVERSATION
    					...
    					if(is_sms){
                            ...
                            sendC2DM(action_data, sanitizedMessageToSend, numberToSendTo, nameOfContact, context, composeWindow, messageTextArea, contacts, 'not-an-mms', batchID);
    					} else {
        					//group picture MMS
        					console.log("sending group pic mms");
        					action_data = 'send_mms_multiple_group_mms';
                            sendC2DM(action_data, sanitizedMessageToSend, numberToSendTo, nameOfContact, context, composeWindow, messageTextArea, contacts, MMSBlobIDForThisThread, batchID);
    					}
...
//                                console.log("sending " + messageToSend + " to: " + numberToSendTo);   
    ...
    //                                console.log("sending " + messageToSend + " to: " + numberToSendTo);   
                ...
                $(messageTextArea).removeAttr("contenteditable");
            }
        }
    };
    ...
    function sendC2DM(action, actionData, targetPhoneNum, targetContactName, context, thisWindow, messageTextArea, contacts, optionalMMSBlobID, optionalBatchID) {
...
/*                                 console.log("this should be a 7 digit phone num clean: "+ phoneNumClean); */
                                ...
                                if (existingWindows.length < 1) {
                                    ...
                                    updateTextWindow(thisWindow, 61, actionData, cleanNum, msgid_just_created_on_server, successTimeStamp, true, 37);
                                }
                            } else {
                            ...
                            var thisResponseArea = $(thisWindow).find(".responseArea");
                            //PRE-KEV VARIABLES FROM MIGHTY.JS
                            ...
                            //CLOSE EMOJI COMPOSER AND SHOW CONVERSATION HOLDER AGAIN. 
                                smartToggleEmojiComposer(thisResponseArea, thisWindow, context);
                            }
                            
                            $(thisWindow).find(".sendSMS").removeClass("textInProgress");
                            $(thisWindow).find(".messageToSend").html('').attr("contenteditable","true").focus();
                        }
                    }
    ...
    function updateTextWindow(window2Update, messageDirection, messageBody, cleanNumTarget, uniqueTextID, messageTimeStamp, sourceClient, optionalContentAuthor, messageType) {
        ...
        var messageToAppend = createHTMLEquivalentOfMessageBody(messageBody);
        //STOP BLINK FUNCTION
        ...
        //APPENDING CONTACT NAME TO MESSAGEBODY IF IT IS AN MMS

        console.log(optionalContentAuthor)
        
        if(optionalContentAuthor != undefined){
            if (messageDirection == 60){
                messageToAppend = messageToAppend + " - <span class='contentAuthor'>" + optionalContentAuthor.contactName+ "</span>";
            }
        }

        
        var htmlForSMS = '<div class="textWrapper ' + incoming_outgoing + ' updatedText" id="message-id-' + uniqueTextID + '"><div class="textInnerWrapper mightyClearfix"><span class="textContent">' + messageToAppend + '</span></div><div class="itemActions"><a id="forwardMessage" data-message-id="' + uniqueTextID + '" data-message-type="' + messageType + '"><img class="forwardMessage messageAction forwardMessageIcon" src="' + forwardImgURL + '"></a><a id="starMessage" data-message-id="' + uniqueTextID + '" class="unstarred"><img class="unstarredicon" src="' + unstarredImgURL + '"></a><a id="deleteMessage" data-message-id="' + uniqueTextID + '" data-message-type="' + messageType + '" data-clean-num="' + cleanNumTarget + '"><img class="deleteOneMessage deleteOneMessageIcon" src="' + deleteImgURL + '"></a><span class="textTimeStamp">' + messageTimeStamp + '</span></div></div>';
...
//                $(this).find(".textContent").text(messageBody);
                addItemActionsEventHandlers(this, window2Update, false);
            });
...
//                $(this).find(".textContent").text(messageBody);
    ...
    function notifyUserSendConfirmation(ContactSentTo, type, batchID) {
        var gmailNotifContainer = $(document).find(".b8.UC");
        var gmailNotif = $(gmailNotifContainer).find(".J-J5-Ji .vh");
        var gmailNotifText = $(gmailNotif).html();
        var sanitizedContact = ContactSentTo;
        var timeDelay = 10000;
...
// 			if (gmailNotif.length > 0) */
            if(gmailNotifText.indexOf("Sent text message to") < 0){
	            $(gmailNotif).html("Sent text message to "+ sanitizedContact);
            } else {
    			$(gmailNotif).append(', ' + sanitizedContact);
            }
        } else if (type == "incomingPhoneCall") {
            $(gmailNotif).html("Incoming call from " + sanitizedContact + "...");
        } else if (type == "missedPhoneCall") {
            $(gmailNotif).html("Missed call from " + sanitizedContact);
        } else if (type == "incomingGroupMMS"){
            $(gmailNotif).html("Incoming group message from " + sanitizedContact + "...");
        } else if (type == "incomingPicMMS"){
            $(gmailNotif).html("Incoming picture message from " + sanitizedContact + "...");
        } else {
            $(gmailNotif).html("Loading...");
            timeDelay = 1000;
        }
    ...
    function processContactForComposeSingleText(contactName, contactNumber, contactInput, contactsToSendSMSTo) {
        //CRV this is where we need to validate that to: number.
        // CRV checks for max number of recipients 
        if ($(contactsToSendSMSTo).children('.contact').length < 10) {
...
/* 			var potentialmessageBody = buildMessageHTML(msg); */
        ...
        if(msg["type"] == 21){
            ...
            if (msg["inbox_outbox"] == 60){
                cleanContentAuthorAndThenCompareToMyContacts(msg["content_author"], msg["id"]);
            }
...
/*		var image_holder_html = '<div id="' + targetPhotoDom + '" style="height:120px"><a id="fancyimagepopup" style="margin-left:25px;" href=""><img style="vertical-align:middle;height:100%" src="http://www.deckmaster.com.ph/images/loading52.gif" alt="Photo in process"></a></div>';	
    ...
    function buildHTMLButtonCanvasMMS(phoneNumClean, currentLocation) {
        var mms_stuff = '';
        ...
        //KL is adding a class depending on the client that is rendering the mms preview.
        mms_stuff += '<div id="holder-mms-image-preview" class="mms-feature" style="display:none;">';
/*
        if(currentLocation == "Gmail"){
            mms_stuff += '<div id="holder-mms-image-preview" class="mms-feature" style="display:none;">';
        } else if (currentLocation == "Facebook") {
            //same html as above, just adding an "fb" class for css purposes.
            mms_stuff += '<div id="holder-mms-image-preview" class="mms-feature fb" style="display:none;">'; 
        }
*/
        //DC Erased inline styling
...
//        mms_stuff += '<div id="mms-upload-dialog" class="mms-feature modal hide fadeMighty" tabindex="-1" role="dialog" style="display:none;"></div>'; /* mms_stuff += '<div id="mms-upload-dialog" class="mms-feature modal hide fadeMighty" tabindex="-1" role="dialog" style="display:none;text-align:left;z-index:50000"></div>'; */
        mms_stuff += '<div id="mms-upload-dialog" class="mms-feature modal fadeMighty" tabindex="-1" role="dialog" style="display:none;"></div>'; /* mms_stuff += '<div id="mms-upload-dialog" class="mms-feature modal hide fadeMighty" tabindex="-1" role="dialog" style="display:none;text-align:left;z-index:50000"></div>'; */
...
*/
    ...
    console.log("called get imageupload code");
        //$.blockUI({ message: '' });
        ...
        $.ajax({
            ...
            success: function(resp, textStatus, jqXHR) {
                console.log("GOT A RESPONSE FROM SERVER FROM IMAGEUPLOAD SERVLET");
...
/*
            var checkIfInFacebook = $(whichCanvasAreaTarget).closest(".notificationWrapper").find(".responseArea.fb");
            
            console.log(checkIfInFacebook);
            
            if(checkIfInFacebook.length > 0){
                alert(1);
            }
*/
...
*/
    ...
    function updateBatteryStatusDisplay(batt_level, batt_charging_icon, timeStamp, unixTimeStamp, tourBatStat) {
        ...
        var dummyBatStat = '<div class="baticon" id="dummyBatStat"><img src="' + phoneImgURL + '"></div><div class="gTextBattery"><div class="batwrap"><div class="batshell"><div class="batbar" style="width:' + batt_level + '%"></div></div><div class="batnub"></div></div><div class="batpercent">' + batt_level_display + '%</div></div>' + batt_charging_icon;
...
*/
        ...
        if(currentPageTitle != messageToToggle){
            ...
            //console.log("toggling back to original");
    ...
    function notifyUserOfNewContentInInactiveTab(optionalStop, messageToToggle){
        ...
        if(optionalStop == "stop"){
            ...
            //console.log("message to send inside of notifyUserOfNewContentInInactiveTab() '"+ messageToToggle + "'");
            detectNonGTextInitiatedChangesToPageTitle(messageToToggle, normalPageTitle);
            pageTitleToggle = setInterval(function(){togglePageTitle(originalPageTitle, messageToToggle);}, 1000);
        }     
...
//                console.log("Got local settings from the background.");
                if (chromeLocalSettingsJSONObj.data && chromeLocalSettingsJSONObj.data == "need to set local settings for first time.") {
                    chrome.storage.local.set({
                        ...
                        'fb_preference': JSON.stringify(0),
...
*/
            ...
            } else if (request.notifyUserOfUpdate){
                runBootStrapGrowl("notifyUserOfUpdate", request.updateContent);
                sendResponse({
                   confirmation: "notified user of update." 
                });
            }
        });
    };
...
//                console.log(existingWindows);
                if (existingWindows.length > 0) {
                    ...
                    updateTextWindow(existingWindows[0], messageDirection, messageBody, scCleanNum, incomingTextID, messageTimeStamp, sourceClient, undefined, 10);
                } else {
...
//                console.log(existingWindows);
                if (existingWindows.length > 0) {                    
                    updateTextWindow(existingWindows[0], messageDirection, messageBody, scCleanNum, incomingTextID, messageTimeStamp, sourceClient, senderContact, 20);
                } else {
                    console.log("this window doesn't exist new logic");
                    if (messageDirection != 61) {
                        console.log("This is not an outgoing text");
...
*/
                ...
                if (existingWindows.length > 0) {
                    ...
                    console.log("this window doesn't exist new logic");
                    if (messageDirection != 61) {
                        getTextsForThisNumber(scCleanNum, scNum, caName, groupMMSContactHeaderNames, contentAuthor.phoneNum );
                    }
                }
...
//                alert("display notif for initial pic mms");
                ...
                //console.log("this is the string we get from the background script '" + request.message + "'");
